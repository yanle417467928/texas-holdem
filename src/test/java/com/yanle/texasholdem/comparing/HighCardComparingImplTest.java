...
public class HighCardComparingImplTest extends TestCase {
    ...
    public void testComparing() {
        Poker card1 = new Poker(PokerColorEnum.DIAMOND, PokerNumEnum.CARD_FOUR);
        Poker card2 = new Poker(PokerColorEnum.CLUB, PokerNumEnum.CARD_THREE);
        Poker card3 = new Poker(PokerColorEnum.DIAMOND, PokerNumEnum.CARD_SIX);
        Poker card4 = new Poker(PokerColorEnum.CLUB, PokerNumEnum.CARD_SEVEN);
        ...
        Poker card21 = new Poker(PokerColorEnum.DIAMOND, PokerNumEnum.CARD_FOUR);
        Poker card22 = new Poker(PokerColorEnum.SPADE, PokerNumEnum.CARD_TWO);
        Poker card23 = new Poker(PokerColorEnum.DIAMOND, PokerNumEnum.CARD_SIX);
        Poker card24 = new Poker(PokerColorEnum.CLUB, PokerNumEnum.CARD_SEVEN);
